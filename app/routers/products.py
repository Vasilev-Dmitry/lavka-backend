...
@router.post("/create", summary="Добавить товар", response_model=schemas.ProductResponse,
...
@router.patch("/update/{product_id}", summary="Редактировать", response_model=schemas.ProductResponse,
...
@router.delete("/delete/{product_id}", summary="Удалить товар", response_model=schemas.Response,
...
@router.post("/upload/{product_id}/images", summary="Загрузить фото товара", response_model=schemas.ProductResponse,
             responses={400: {"model": schemas.ErrorMessage}, 404: {"model": schemas.ErrorMessage}, 500: {"model": schemas.ErrorMessage}, 429: {"model": schemas.ErrorMessage}})
@limiter.limit("10/minute")
...
@router.delete("/delete/{product_id}/images/{image_index}", summary="Удалить фото товара", response_model=schemas.ProductResponse)
@limiter.limit("10/minute")
